...
import type { PlayerControllerHandle } from "../../scene-content/components/player-controller/types/types";
import type { DestinationsByCategory } from "@/components-v5/shared/types";
    ...
    <div className="pointer-events-none fixed left-0 right-0 top-[40%] z-[200] flex justify-center px-4 short:top-[44%]">
      ...
      >
        ...
        <div
          ...
          style={{ background: "rgba(41,151,255,0.18)", border: "1px solid rgba(41,151,255,0.32)" }}
        >
