 ...
 * InteriorContext
 * ─────────────────────────────────────────────────────────────────────────────
 * React context that bridges InteriorScene (HTML shell) and SceneContent (R3F canvas).
...
import type { MinimapData } from "../minmap";
import type { FloorConfig } from "@/components-v5/shared/types";

export interface InteriorContextValue {
...
export const InteriorContext = createContext<InteriorContextValue>(null!);
export const useInterior = () => useContext(InteriorContext);
