...
import { etaSeconds, fmtEta, fmtMeters } from "../../ui/nav-hud/format";
import { navConfig } from "../../nav-config";
import { CROWD_FLOW_COLOR } from "../../scene-content/components/crowd-flow";
import { CROWD_DOT } from "../../ui/destination-sheet/destination-card";
import { DEST_CATEGORIES } from "../../ui/destination-sheet/category-meta";
...
export function useMinimap() {
  const { playerControllerRef, minimapData, navigateFromMinimap, activeFloor, isMoving, triggerFloorTransition, layoutsOpen, setLayoutsOpen, fovOpen, setFovOpen } = useInterior();
