...
import type { PlayerControllerHandle } from "../components/player-controller";
...
export function useSceneNavigation({
  ...
  // triggerFloorTransition is called by handleFloorSelect in InteriorScene (HTML tree)
  ...
  const { pendingLayoutEntryRef } = useInterior();
