 ...
 * InteriorScene shell can drive navigation without causing re-renders.
 *
...
import type { RoomZone }         from "../navmesh/navmesh-geomtery";
import type { PlayerControllerHandle, PlayerControllerProps } from "./types/types";
...
export const PlayerController = forwardRef<PlayerControllerHandle, PlayerControllerProps>(
  (
    ...
    // Idle drift is gated externally — InteriorScene calls startIdleDrift() after reveal
